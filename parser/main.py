        ...
        try:
            while self.current_token != None and self.current_token.type in (
                ...
                if self.current_token.type == TokenType.PLUS:
                    self.advance()
                    if self.current_token.type == TokenType.MINUS or self.current_token.type == TokenType.PLUS:
                        self.error()
                    result = AddNode(result, self.term())
                elif self.current_token.type == TokenType.MINUS:
                    self.advance()
                    if self.current_token.type == TokenType.PLUS or self.current_token.type == TokenType.MINUS:
                        self.error()
